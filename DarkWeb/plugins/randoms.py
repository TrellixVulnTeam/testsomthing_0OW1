...
@Dark.on(admin_cmd(pattern=r"sing$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"sing$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=f"hps$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"hps$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=f"gott$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"gott$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=f"gotm$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"gotm$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern="bello$", outgoing=True))
@Dark.on(sudo_cmd(pattern="bello$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    event = await edit_or_reply(event, "Typing....")
...
@Dark.on(admin_cmd(pattern=r"tip$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"tip$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=r"qt$"))
@Dark.on(sudo_cmd(pattern=r"qt$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=f"logic$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"logic$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=r"snow$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"sonw$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=r"shayri$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"shayri$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=r"hflirt$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"hflirt$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=r"eflirt$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"eflirt$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    event = await edit_or_reply(event, "Hey! Here's a fact about you......")
...
@Dark.on(admin_cmd(pattern=r"attitude$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"attitude$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    event = await edit_or_reply(event, "🤙")
...
@Dark.on(admin_cmd(pattern="gbye$", outgoing=True))
@Dark.on(sudo_cmd(pattern="gbye$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
