...
from DarkWeb import OPEN_WEATHER_MAP_APPID as OWM_API
from Dark.utils import errors_handler
...
@Dark.on(admin_cmd(pattern="weather(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="weather(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@Dark.on(admin_cmd(pattern="setcity(?: |$)(.*)", outgoing=True))
