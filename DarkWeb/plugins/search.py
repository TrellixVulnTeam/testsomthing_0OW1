...
@Dark.on(admin_cmd(pattern="ytube (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="ytube (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern="ddg (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="ddg (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="altn (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="altn (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="var (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="var (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="lmlog (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="lmlog (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="hacc (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="hacc (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="lmkp (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="lmkp (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="gem (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="gem (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="rchiv (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="rchiv (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
