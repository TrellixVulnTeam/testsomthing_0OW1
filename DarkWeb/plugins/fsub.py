...
from DarkWeb.sql_helper.fsub_sql import *
from . import *
"""
...
@Dark.on(admin_cmd(pattern="fsub ?(.*)"))
@Dark.on(sudo_cmd(pattern="fsub ?(.*)", allow_sudo=True))
async def _(event):
    if event.is_private:
...
@Dark.on(admin_cmd(pattern="rmfsub"))
@Dark.on(sudo_cmd(pattern="rmfsub", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="chfsub"))
@Dark.on(sudo_cmd(pattern="chfsub", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="lsfsub$"))
@Dark.on(sudo_cmd(pattern="lsfsub$", allow_sudo=True))
