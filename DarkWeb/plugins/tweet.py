...
@Dark.on(admin_cmd(pattern=r"tweet(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="tweet(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern=r"trump(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"trump(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern=r"modi(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"modi(?: |$)(.*)", allow_sudo=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@Dark.on(admin_cmd(pattern=r"mia(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"mia(?: |$)(.*)", allow_sudo=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@Dark.on(admin_cmd(pattern=r"dani(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"dani(?: |$)(.*)", allow_sudo=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@Dark.on(admin_cmd(pattern=r"pappu(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"pappu(?: |$)(.*)", allow_sudo=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@Dark.on(admin_cmd(pattern=r"sunny(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"sunny(?: |$)(.*)", allow_sudo=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@Dark.on(admin_cmd(pattern=r"johhny(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"johhny(?: |$)(.*)", allow_sudo=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@Dark.on(admin_cmd(pattern=r"gandhi(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"gandhi(?: |$)(.*)", allow_sudo=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@Dark.on(admin_cmd(pattern=r"cmm(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"cmm(?: |$)(.*)", allow_sudo=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
...
@Dark.on(admin_cmd(pattern=r"kanna(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern=r"kanna(?: |$)(.*)", allow_sudo=True))
async def nekobot(borg):
    text = borg.pattern_match.group(1)
    reply_to_id = borg.message
    if borg.reply_to_msg_id:
