...
@DarkWeb.on(admin_cmd(pattern=r"unpack", outgoing=True))
@DarkWeb.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@DarkWeb.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@DarkWeb.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
