...
@Dark.on(admin_cmd(pattern=r"(\w+)say (.*)"))
@Dark.on(sudo_cmd(pattern=r"(\w+)say (.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern=":/$", outgoing=True))
@Dark.on(sudo_cmd(pattern=":/$", allow_sudo=True))
async def kek(keks):
...
@Dark.on(admin_cmd(pattern="slap(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="slap(?: |$)(.*)", allow_sudo=True))
async def who(event):
...
@Dark.on(admin_cmd(pattern="-_-$", outgoing=True))
@Dark.on(sudo_cmd(pattern="-_-$", allow_sudo=True))
async def lol(lel):
...
@Dark.on(admin_cmd(pattern="cry$", outgoing=True))
@Dark.on(sudo_cmd(pattern="cry$", allow_sudo=True))
async def cry(e):
...
@Dark.on(admin_cmd(pattern="cp(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="cp(?:|$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="vapor(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="vapor(?: |$)(.*)", allow_sudo=True))
async def vapor(vpr):
    """ Vaporize everything! """
...
@Dark.on(admin_cmd(pattern=f"repo", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"repo", allow_sudo=True))
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/Dark725/DarkWeb) to open this 🔥**Lit AF!!**🔥 __DarkWeb__ Repo.. Join channel :- @DarkWeb_Support")


@Dark.on(admin_cmd(pattern="str(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="str(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="zal(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="zal(?: |$)(.*)", allow_sudo=True))
async def zal(zgfy):
...
@Dark.on(admin_cmd(pattern="pkill$", outgoing=True))
@Dark.on(sudo_cmd(pattern="pkill$", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="bt$", outgoing=True))
@Dark.on(sudo_cmd(pattern="bt$", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="owo(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="owo(?: |$)(.*)", allow_sudo=True))
async def faces(owo):
    """ UwU """
...
@Dark.on(admin_cmd(pattern="react$", outgoing=True))
@Dark.on(sudo_cmd(pattern="react$", allow_sudo=True))
async def react_meme(react):
    """ Make your userbot react to everything. """
    if not react.text[0].isalpha() and react.text[0] not in ("/", "#", "@", "!"):
        await edit(react, random.choice(FACEREACTS))

@Dark.on(admin_cmd(pattern="shg$", outgoing=True))
@Dark.on(sudo_cmd(pattern="shg$", allow_sudo=True))
async def shrugger(shg):
    r""" ¯\_(ツ)_/¯ """
    if not shg.text[0].isalpha() and shg.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(shg, random.choice(SHGS))

@Dark.on(admin_cmd(pattern="10iq$", outgoing=True))
@Dark.on(sudo_cmd(pattern="10iq$", allow_sudo=True))
async def iqless(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "♿")

@Dark.on(admin_cmd(pattern="mock(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="mock(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="clap(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="clap(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="smk (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="smk (.*)", allow_sudo=True))
async def smrk(smk):
...
@Dark.on(admin_cmd(pattern="lfy (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="lfy (.*)", allow_sudo=True))
