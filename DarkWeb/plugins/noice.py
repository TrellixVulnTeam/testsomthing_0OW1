...
@Dark.on(admin_cmd(pattern="cri$", outgoing=True))
@Dark.on(sudo_cmd(pattern="cri$", allow_sudo=True))
async def cri(e):
...
@Dark.on(admin_cmd(pattern="hey$", outgoing=True))
@Dark.on(sudo_cmd(pattern="hey$", allow_sudo=True))
async def hoi(hello):
    """ Greet everyone! """
...
@Dark.on(admin_cmd(pattern="shrug$", outgoing=True))
@Dark.on(sudo_cmd(pattern="shrug$", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="f (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="f (.*)", allow_sudo=True))
async def payf(e):
...
@Dark.on(admin_cmd(pattern="nopee$", outgoing=True))
@Dark.on(sudo_cmd(pattern="nopee$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern="^Okk$", outgoing=True))
@Dark.on(sudo_cmd(pattern="^Okk$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
