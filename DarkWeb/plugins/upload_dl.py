...
from DarkWeb import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
...
@Dark.on(admin_cmd(pattern=r"download(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"download(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern=r"uploadir (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"uploadir (.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern=r"upload (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"upload (.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern=r"uploadas(stream|vn|all) (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"uploadas (stream|vn|all) (.*)", allow_sudo=True))
...
CmdHelp("upld_dwl").add_command(
  "download", "<reply to a file>", "Downloads the file to DarkWeb's server"
).add_command(
