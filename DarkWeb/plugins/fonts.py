...
@Dark.on(admin_cmd(pattern="weeb(?: |$)(.*)", command="weeb"))
@Dark.on(sudo_cmd(pattern="weeb(?: |$)(.*)", command="weeb", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="tanify(?: |$)(.*)", command="tanify"))
@Dark.on(sudo_cmd(pattern="tanify(?: |$)(.*)", command="tanify", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="lintxt(?: |$)(.*)", command="lintxt"))
@Dark.on(sudo_cmd(pattern="lintxt(?: |$)(.*)", command="lintxt", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="boxify(?: |$)(.*)", command="boxify"))
@Dark.on(sudo_cmd(pattern="boxify(?: |$)(.*)", command="boxify", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="bubble(?: |$)(.*)", command="bubble"))
@Dark.on(sudo_cmd(pattern="bubble(?: |$)(.*)", command="bubble", allow_sudo=True))
