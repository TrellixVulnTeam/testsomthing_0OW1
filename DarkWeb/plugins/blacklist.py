...
from DarkWeb.sql_helper import blacklist_sql as sql
...
@Dark.on(admin_cmd(pattern="addblacklist ((.|\n)*)"))
@Dark.on(sudo_cmd(pattern="addblacklist ((.|\n)*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="rmblacklist ((.|\n)*)"))
@Dark.on(sudo_cmd(pattern="rmblacklist ((.|\n)*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="listblacklist$"))
@Dark.on(sudo_cmd(pattern="listblacklist$", allow_sudo=True))
