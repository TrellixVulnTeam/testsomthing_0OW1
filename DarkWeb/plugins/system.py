...
@Dark.on(admin_cmd(pattern=f"quickheal$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"quickheal$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=f"sqh$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"sqh$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=f"vquickheal$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"vquickheal$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 5
...
@Dark.on(admin_cmd(pattern=f"macos$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"macos$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=f"windows$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"windows$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
...
@Dark.on(admin_cmd(pattern=f"linux$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"linux$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
...
@Dark.on(admin_cmd(pattern=f"stock$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"stock$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
...
@Dark.on(admin_cmd(pattern=f"os$", outgoing=True))
@Dark.on(sudo_cmd(pattern=f"os$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
