...
from Dark.utils import errors_handler, admin_cmd, sudo_cmd, edit_or_reply
from DarkWeb.cmdhelp import CmdHelp

@Dark.on(admin_cmd(pattern="hash (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="hash (.*)", allow_sudo=True))
@errors_handler
...
@Dark.on(admin_cmd(pattern="hbase (en|de) (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="hbase (en|de) (.*)", allow_sudo=True))
@errors_handler
