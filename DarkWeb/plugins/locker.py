...
from Dark.utils import errors_handler, register
...
@Dark.on(admin_cmd(pattern=r"lock ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"lock ?(.*)", allow_sudo=True))
@errors_handler
...
@Dark.on(admin_cmd(pattern="unlock ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="unlock ?(.*)", allow_sudo=True))
@errors_handler
...
@Dark.on(admin_cmd(pattern="ltype$"))
@Dark.on(sudo_cmd(pattern="ltype$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
