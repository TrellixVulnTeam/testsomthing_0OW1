...
@Dark.on(admin_cmd(pattern=r"warn1", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"warn1", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = (
...
@Dark.on(sudo_cmd(pattern=r"warn3", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = (
...
@Dark.on(sudo_cmd(pattern=r"ocb", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=r"fw", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"fw", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
