...
from DarkWeb.sql_helper.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
@Dark.on(admin_cmd(incoming=True))
...
@Dark.on(admin_cmd(pattern="savefilter (.*)"))
@Dark.on(sudo_cmd(pattern="savefilter (.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="listfilter$"))
@Dark.on(sudo_cmd(pattern="listfilter$", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="stop (.*)"))
@Dark.on(sudo_cmd(pattern="stop (.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="clearallfilters$"))
@Dark.on(sudo_cmd(pattern="clearallfilters$", allow_sudo=True))
