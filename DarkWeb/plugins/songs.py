...
from Dark.utils import admin_cmd, sudo_cmd, edit_or_reply, progress
from DarkWeb.cmdhelp import CmdHelp
from DarkWeb.helpers.functions import deEmojify

@Dark.on(admin_cmd(pattern="lyrics(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="lyrics(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="gaana ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="gaana ?(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="song(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="song(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="vsong(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="vsong(?: |$)(.*)", allow_sudo=True))
async def download_video(v_url):
    lazy = v_url
    sender = await lazy.get_sender()
    me = await lazy.client.get_me()
...
@Dark.on(admin_cmd(pattern="getsong(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="getsong(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="dwlsong(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="dwlsong(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="sdd ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="sdd?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with borg.conversation("@DeezLoadBot") as conv:
        try:
            ...
            await borg.send_file(
                event.chat_id,
                songh,
                caption="🔆**Here's the requested song!**🔆\n`Check out` [DarkWeb](https://t.me/DarkWeb_Chit_Chat)",
            )
            await event.delete()
        except YouBlockedUserError:
