...
from DarkWeb import *
from DarkWeb.sql_helper.mute_sql import is_muted, mute, unmute
...
@Dark.on(admin_cmd("setgpic$"))
@Dark.on(sudo_cmd(pattern="setgpic$", allow_sudo=True))
@errors_handler
...
@Dark.on(admin_cmd("promote(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def promote(promt):
    ...
    try:
        ...
        await Darkevent.edit("Promoted Successfully! ABB GROUP KAA BAAP NAHI BANA GAYA")
...
@Dark.on(admin_cmd("demote(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def demote(dmod):
    ...
    try:
        ...
        await Darkevent.edit(NO_PERM)
        return
    await Darkevent.edit("Demoted Successfully!BHUT HERO BAN RAHA THA ABB BANA HERO")
    if BOTLOG:
...
@Dark.on(admin_cmd("ban(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="ban(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def ban(bon):
    if bon.fwd_from:
        return
...
@Dark.on(admin_cmd("unban(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="unban(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def nothanos(unbon):
    ...
    try:
        ...
        await Darkevent.edit("Unbanned Successfully!ABB AA GAYA OKAD MEE")
        if BOTLOG:
...
@Dark.on(admin_cmd("pin($| (.*))"))
@Dark.on(sudo_cmd(pattern="pin($| (.*))", allow_sudo=True))
@errors_handler
async def pin(msg):
    if msg.fwd_from:
        return
...
@Dark.on(admin_cmd("kick(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
    if usr.fwd_from:
        return
...
@Dark.on(admin_cmd("undlt$"))
@Dark.on(sudo_cmd(pattern="undlt$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.fwd_from:
