...
from Dark.utils import admin_cmd, errors_handler, sudo_cmd, edit_or_reply
from DarkWeb.cmdhelp import CmdHelp


@Dark.on(admin_cmd(pattern="chatinfo(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="chatinfo(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="adminlist", outgoing=True))
@Dark.on(sudo_cmd(pattern="adminlist", allow_sudo=True))
@errors_handler
...
@Dark.on(admin_cmd(pattern=r"users ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"users ?(.*)", allow_sudo=True))
