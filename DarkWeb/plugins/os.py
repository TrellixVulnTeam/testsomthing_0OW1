...
@Dark.on(admin_cmd(pattern=r"macos$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"macos$", allow_sudo=True))
async def _(event):
...
@Dark.on(admin_cmd(pattern=r"windows$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"windows$", allow_sudo=True))
async def _(event):
...
@Dark.on(admin_cmd(pattern=r"linux$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"linux$", allow_sudo=True))
async def _(event):
...
@Dark.on(admin_cmd(pattern=r"stock$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"stock$", allow_sudo=True))
async def _(event):
...
@Dark.on(admin_cmd(pattern=r"os$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"os$", allow_sudo=True))
async def _(event):
