...
@DarkWeb.on(admin_cmd(pattern="sin ?(.*)"))
@DarkWeb.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@DarkWeb.on(admin_cmd(pattern="cos ?(.*)"))
@DarkWeb.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@DarkWeb.on(admin_cmd(pattern="tan ?(.*)"))
@DarkWeb.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@DarkWeb.on(admin_cmd(pattern="cosec ?(.*)"))
@DarkWeb.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@DarkWeb.on(admin_cmd(pattern="sec ?(.*)"))
@DarkWeb.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@DarkWeb.on(admin_cmd(pattern="cot ?(.*)"))
@DarkWeb.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@DarkWeb.on(admin_cmd(pattern="square ?(.*)"))
@DarkWeb.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@DarkWeb.on(admin_cmd(pattern="cube ?(.*)"))
@DarkWeb.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
