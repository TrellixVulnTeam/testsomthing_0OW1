...
@Dark.on(admin_cmd(pattern="waifu(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="waifu(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern=r"stcr ?(?:(.*?) \| )?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"stcr ?(?:(.*?) \| )?(.*)", allow_sudo=True))
async def sticklet(event):
    ...
    image_stream.name = "DarkWeb.webp"
