...
@Dark.on(admin_cmd(pattern="google (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="google (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@Dark.on(admin_cmd(pattern="image (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="image (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@Dark.on(admin_cmd(pattern="reverse"))
@Dark.on(sudo_cmd(pattern="reverse", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
