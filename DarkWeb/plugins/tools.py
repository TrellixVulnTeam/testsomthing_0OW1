...
@Dark.on(admin_cmd(pattern="scan ?(.*)"))
@Dark.on(sudo_cmd(pattern="scan ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=r"decode$", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"decode$", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="barcode ?(.*)"))
@Dark.on(sudo_cmd(pattern="barcode ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=r"makeqr(?: |$)([\s\S]*)", outgoing=True))
@Dark.on(sudo_cmd(pattern=r"makeqr(?: |$)([\s\S]*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="currency (.*)"))
@Dark.on(sudo_cmd(pattern="currency (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="currencies$"))
@Dark.on(sudo_cmd(pattern="currencies$", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="ifsc (.*)"))
@Dark.on(sudo_cmd(pattern="ifsc (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="color (.*)"))
@Dark.on(sudo_cmd(pattern="color (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@Dark.on(admin_cmd(pattern="xkcd ?(.*)"))
@Dark.on(sudo_cmd(pattern="xkcd ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
CmdHelp("tools").add_command(
  ...
  "currency", "<amount> <from> <to>", "Currency converter for Dark", ".currency 10 usd inr"
).add_command(
