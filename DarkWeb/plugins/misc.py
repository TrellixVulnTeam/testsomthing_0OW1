...
@Dark.on(admin_cmd(pattern="random", outgoing=True))
@Dark.on(sudo_cmd(pattern="random", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="sleep([0-9]+)?$", outgoing=True))
@Dark.on(sudo_cmd(pattern="sleep([0-9]+)?$", allow_sudo=True))
