...
@Dark.on(admin_cmd(pattern="mute ?(\d+)?", outgoing=True))
@Dark.on(sudo_cmd(pattern="mute ?(\d+)?", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="unmute ?(\d+)?", outgoing=True))
@Dark.on(sudo_cmd(pattern="unmute ?(\d+)?", allow_sudo=True))
