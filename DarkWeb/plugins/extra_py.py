...
from Dark.utils import admin_cmd, load_module
from var import Var
from DarkWeb.cmdhelp import CmdHelp

@Dark.on(admin_cmd(pattern="extdl$", outgoing=True))
...
CmdHelp("extra_py").add_command(
  'extdl', None, 'Installs all plugins from the channal which id is in DARKWEB_ID variable'
).add_command(
