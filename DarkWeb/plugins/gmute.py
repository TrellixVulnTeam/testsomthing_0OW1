...
@Dark.on(admin_cmd(pattern=r"gmute ?(\d+)?"))
@Dark.on(sudo_cmd(pattern=r"gmute ?(\d+)?", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern=r"ungmute ?(\d+)?"))
@Dark.on(sudo_cmd(pattern=r"ungmute ?(\d+)?", allow_sudo=True))
