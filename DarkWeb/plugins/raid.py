...
@Dark.on(admin_cmd(pattern="replyraid(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="replyraid(?: |$)(.*)", allow_sudo=True))
async def _(event):
    global que
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern="dreplyraid(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="dreplyraid(?: |$)(.*)", allow_sudo=True))
async def _(event):
    global que
    if event.fwd_from:
        return
