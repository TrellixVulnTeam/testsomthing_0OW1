...
@Dark.on(admin_cmd(pattern="ocrlang", outgoing=True))
@Dark.on(sudo_cmd(pattern="ocrlang", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="ocr (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="ocr (.*)", allow_sudo=True))
