...
@Dark.on(admin_cmd(pattern=r"kickall ?(.*)"))
@Dark.on(admin_cmd(pattern=r"kickall ?(.*)", allow_sudo=True))
async def _(event):
...
@Dark.on(admin_cmd(pattern=r"banall ?(.*)"))
@Dark.on(sudo_cmd(pattern=r"banall ?(.*)", allow_sudo=True))
async def _(event):
    result = await event.client(
        functions.channels.GetParticipantRequest(event.chat_id, event.client.uid)
    )
...
@Dark.on(admin_cmd(pattern=r"unbanall ?(.*)"))
@Dark.on(sudo_cmd(pattern=r"unbanall ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern="ikuck ?(.*)"))
@Dark.on(sudo_cmd(pattern="ikuck ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.is_private:
