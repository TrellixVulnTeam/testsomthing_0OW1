...
@Dark.on(admin_cmd(pattern="paste ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="paste ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@Dark.on(admin_cmd(pattern="getpaste(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="getpaste(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="neko ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="neko ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    datetime.now()
...
@Dark.on(admin_cmd(pattern="iffuci ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="iffuci ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    start = datetime.now()
...
@Dark.on(admin_cmd(pattern="paster ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="paster ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    datetime.now()
