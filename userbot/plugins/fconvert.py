...
from Dark.utils import admin_cmd, edit_or_reply, progress, sudo_cmd
from DarkWeb import CMD_HELP
from DarkWeb.helpers.functions import unzip
...
@Dark.on(admin_cmd(pattern="stoi$"))
@Dark.on(sudo_cmd(pattern="stoi$", allow_sudo=True))
async def _(Dark):
    if Dark.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern="itos$"))
@Dark.on(sudo_cmd(pattern="itos$", allow_sudo=True))
async def _(Dark):
    if Dark.fwd_from:
        return
    reply_to_id = Dark.message.id
...
@Dark.on(admin_cmd(pattern="ttf ?(.*)"))
@Dark.on(sudo_cmd(pattern="ttf ?(.*)", allow_sudo=True))
async def get(event):
    if event.fwd_from:
        return
    name = event.text[5:]
...
@Dark.on(admin_cmd(pattern="ftoi$"))
@Dark.on(sudo_cmd(pattern="ftoi$", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="gif$"))
@Dark.on(sudo_cmd(pattern="gif$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern="nfc ?(.*)"))
@Dark.on(sudo_cmd(pattern="nfc ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
