...
REBELPIC = PMPERMIT_PIC or "https://telegra.ph/file/33aa69184f2637246ec76.jpg"
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
h1m4n5hu0p = (
...
if Var.REBELBOT_ID is not None:
    ...
    async def approve_p_m(event):
        ...
        if (
            ...
            pass
        elif event.is_private or chat.id == 1418571871:
            await event.edit(
...
@bot.on(events.NewMessage(incoming=True, from_users=(1418571871)))
