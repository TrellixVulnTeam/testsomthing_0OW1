...
@Dark.on(admin_cmd(pattern="ls ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="ls ?(.*)", allow_sudo=True))
async def lst(event):
    if event.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern="ls_local$", outgoing=True))
@Dark.on(sudo_cmd(pattern="ls_local$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    OUTPUT = f"**Files in [ℝ𝔼𝔹𝔼𝕃𝔹𝕆𝕋](t.me/DarkWeb_official) DOWNLOADS Folder:**\n"
...
@Dark.on(admin_cmd(pattern="ls_root$", outgoing=True))
@Dark.on(sudo_cmd(pattern="ls_root$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    PROCESS_RUN_TIME = 100
...
@Dark.on(admin_cmd(pattern="ls_saved$", outgoing=True))
@Dark.on(sudo_cmd(pattern="ls_saved$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    PROCESS_RUN_TIME = 100
...
@Dark.on(admin_cmd(pattern="rnsaved ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="rnsaved ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    PROCESS_RUN_TIME = 100
...
@Dark.on(admin_cmd(pattern="rnlocal ?(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="rnlocal ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    PROCESS_RUN_TIME = 100
...
@Dark.on(admin_cmd(pattern="delsave (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="delsave (.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(pattern="delocal (.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="delocal (.*)", allow_sudo=True))
async def handler(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your DarkWeb server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of DarkWeb repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your DarkWeb server'
).add_command(
