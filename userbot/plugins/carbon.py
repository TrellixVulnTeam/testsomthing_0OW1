...
@Dark.on(admin_cmd(outgoing=True, pattern="carbon(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="carbon(?: |$)(.*)", allow_sudo=True))
...
@Dark.on(admin_cmd(outgoing=True, pattern="krb"))
@Dark.on(sudo_cmd(pattern="krb", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=f"kar1(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="kar1(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
...
@Dark.on(admin_cmd(pattern=f"kar2(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="kar2(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
...
@Dark.on(admin_cmd(pattern=f"kar3(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="kar3(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
...
@Dark.on(admin_cmd(pattern=f"kar4(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="kar4(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
...
@Dark.on(admin_cmd(pattern=f"rgbk2(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="rgbk2(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
...
@Dark.on(admin_cmd(pattern=f"kargb(?: |$)(.*)", outgoing=True))
@Dark.on(sudo_cmd(pattern="kargb(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    RED = random.randint(0, 256)
