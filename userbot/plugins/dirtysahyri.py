...
async def _(event):
    ...
    if s == 7:
        await event.edit(
            "Kuchh to thaa unke labon par jo wo hume dekhkar itna badbadati thi,Fir pata chala ek din ki wo to gutkha chabaati thi"
        )
    if s == 8:
        await event.edit(
            "Tangon Ko Utha, Kuchh Ch**T Dikha,\nMere L*Nd Par Zara Haath Fira\nYeh Ch**T Khushi Mein Hansti Hai,\nL*Nd Bhi Hilta Hai Masti Mein,"
        )
    if s == 9:
        await event.edit(
    ...
    if s == 19:
        await event.edit(
            "अर्ज़ किया है… ज़िन्दगी लवडों का पुलिंदा है, चूत आजकल चुनिंदा है… कभी याद कर लिया करो इस नाचीज़ को भी, ये शख्स सिर्फ आपकी गां# मारने के लिए जिंदा है।"
        )
