...
from Dark.utils import admin_cmd, edit_or_reply, errors_handler, sudo_cmd
...
@Dark.on(admin_cmd(outgoing=True, pattern="climate( (.*)|$)"))
@Dark.on(sudo_cmd(pattern="climate( (.*)|$)", allow_sudo=True))
@errors_handler
...
@Dark.on(admin_cmd(outgoing=True, pattern="setcity(?: |$)(.*)"))
@Dark.on(sudo_cmd(pattern="setcity(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@Dark.on(admin_cmd(pattern="wttr ?(.*)"))
@Dark.on(sudo_cmd(pattern="wttr ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    global DEFCITY
