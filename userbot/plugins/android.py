...
@Dark.on(admin_cmd(pattern=r"magisk"))
@Dark.on(sudo_cmd(pattern=r"magisk", allow_sudo=True))
...
@Dark.on(admin_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
@Dark.on(sudo_cmd(pattern=r"device(?: |$)(\S*)", allow_sudo=True))
...
@Dark.on(admin_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
@Dark.on(sudo_cmd(pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@Dark.on(admin_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
@Dark.on(sudo_cmd(pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@Dark.on(admin_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
@Dark.on(sudo_cmd(pattern=r"twrp(?: |$)(\S*)", allow_sudo=True))
