# credits to userge
# ported to DarkWeb by @Dark_is_op
...
@Dark.on(admin_cmd("boobs$"))
@Dark.on(sudo_cmd(pattern="boobs$", allow_sudo=True))
...
@Dark.on(admin_cmd("butts$"))
@Dark.on(sudo_cmd(pattern="butts$", allow_sudo=True))
